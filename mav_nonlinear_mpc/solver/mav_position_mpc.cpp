...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_f1 << 1/(1.00000000000000000000e+00+pow(2.71799999999999997158e+00,((-(-sin(pitch))*(position3-target_position3)-(position1-target_position1)*cos(pitch)*cos(yaw)-(position2-target_position2)*cos(pitch)*sin(yaw))/5.00000000000000027756e-02-3.00000000000000000000e+00)));
    ...
    acadodata_f2 << 1/(1.00000000000000000000e+00+pow(2.71799999999999997158e+00,((-(-sin(pitch))*(position3-target_position3)-(position1-target_position1)*cos(pitch)*cos(yaw)-(position2-target_position2)*cos(pitch)*sin(yaw))/5.00000000000000027756e-02-3.00000000000000000000e+00)));
    OCP ocp1(0, 2, 20);
