...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_f1 << (1/pow((1.00000000000000000000e+00+pow(2.71799999999999997158e+00,((-sqrt((-pow(((cos(roll)*cos(yaw)*sin(pitch)+sin(roll)*sin(yaw))*(position1-target_position1)+(cos(roll)*sin(pitch)*sin(yaw)-cos(yaw)*sin(roll))*(position2-target_position2)+(position3-target_position3)*cos(pitch)*cos(roll)),2.00000000000000000000e+00)+pow(sqrt((pow((position1-target_position1),2.00000000000000000000e+00)+pow((position2-target_position2),2.00000000000000000000e+00)+pow((position3-target_position3),2.00000000000000000000e+00))),2.00000000000000000000e+00))))/2.00000000000000004163e-02-8.09999999999999964473e+00))),2.00000000000000000000e+00)+3.20000000000000017764e+00*pow(sqrt((-pow(((cos(roll)*cos(yaw)*sin(pitch)+sin(roll)*sin(yaw))*(position1-target_position1)+(cos(roll)*sin(pitch)*sin(yaw)-cos(yaw)*sin(roll))*(position2-target_position2)+(position3-target_position3)*cos(pitch)*cos(roll)),2.00000000000000000000e+00)+pow(sqrt((pow((position1-target_position1),2.00000000000000000000e+00)+pow((position2-target_position2),2.00000000000000000000e+00)+pow((position3-target_position3),2.00000000000000000000e+00))),2.00000000000000000000e+00))),4.00000000000000000000e+00));
